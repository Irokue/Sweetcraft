...
public class EntityArrowRedstone extends Entity
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityArrowRedstone(World par1World)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
    ...
    public EntityArrowRedstone(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
    ...
    public EntityArrowRedstone(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
    ...
    public EntityArrowRedstone(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        xTile = -1;
        yTile = -1;
    ...
    public void onUpdate()
    {
        ...
        if (movingobjectposition != null)
        {
            ...
            else
            {
                ...
                {
                	worldObj.setBlockWithNotify((int)posX,(int)posY,(int)posZ,Block.torchRedstoneActive.blockID);
                }
                worldObj.playSoundAtEntity(this, "random.bowhit", 1.0F, 1.2F / (rand.nextFloat() * 0.2F + 0.9F));
                inGround = true;
                arrowShake = 7;
