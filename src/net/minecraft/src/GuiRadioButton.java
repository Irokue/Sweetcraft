...
public class GuiRadioButton extends GuiButton{
	...
	public GuiRadioButton(int par1, int par2, int par3, int par4, int par5,
			String par6Str) {
		super(par1, par2, par3, par4, par5, par6Str);
	}
	
	public GuiRadioButton(int id, int xPosition, int yPosition, String text, boolean checked, Minecraft mc){
	  ...
	  public void drawButton(Minecraft par1Minecraft, int par2, int par3)
    {
        ...
        drawTexturedModalRect(xPosition, yPosition, 40, i, width, height);
