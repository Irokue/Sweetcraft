...
class ContainerCreative extends Container
{
    ...
    public ContainerCreative(EntityPlayer par1EntityPlayer)
    {
        ...
        Block ablock[] =
        {
            ...
            Block.stairDouble, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.stairSingle, Block.obsidian, Block.netherrack, Block.slowSand, Block.glowStone,
            ...
            Block.trapdoor, Block.enchantmentTable, Block.redstoneLampIdle, Block.chaise, Block.table, Block.X, Block.grappeCrops
        };
        int i = 0;
        int j = 0;
        int k = 0;
