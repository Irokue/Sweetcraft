...
public class EntityChevalBlanc extends EntityAnimal
{
	 float f = 1.8F;
    public EntityChevalBlanc(World par1World)
    {
        super(par1World);
        texture = "/mob/ChevalBlanc.png";
        setSize(1.4F, 1.4F);
	...
	public void updateEntityActionState()
	{
		if (riddenByEntity != null )
		{
			...
			{
				 motionX+=((EntityPlayer)riddenByEntity).motionX*f;
				 motionY+=((EntityPlayer)riddenByEntity).motionY*f;
				 motionZ+=((EntityPlayer)riddenByEntity).motionZ*f;
			}
			rotationPitch=0;
    ...
    {
        return new EntityChevalBlanc(worldObj);
    }
