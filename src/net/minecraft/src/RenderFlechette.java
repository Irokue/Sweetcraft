...
{
    public RenderFlechette()
    {
    }

    public void renderFlechette(EntityFlechette par1EntityFlechette, double par2, double par4, double par6, float par8, float par9)
    {
        loadTexture("/item/arrow.png");
        GL11.glPushMatrix();
        GL11.glTranslatef((float)par2, (float)par4, (float)par6);
        GL11.glRotatef((par1EntityFlechette.prevRotationYaw + (par1EntityFlechette.rotationYaw - par1EntityFlechette.prevRotationYaw) * par9) - 90F, 0.0F, 1.0F, 0.0F);
        ...
        float f9 = (float)par1EntityFlechette.arrowShake - par9;
    ...
    {
        renderFlechette((EntityFlechette)par1Entity, par2, par4, par6, par8, par9);
    }
}
