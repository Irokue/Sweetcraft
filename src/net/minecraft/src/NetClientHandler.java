...
public class NetClientHandler extends NetHandler {
	...
	public void handleQuests(Packet136Quest packet) {
		if (packet.playerId == mc.thePlayer.entityId) {
			mc.thePlayer.questsTitles = packet.questsTitles;
			String questDesc = packet.questsDesc;
			questDesc = questDesc.replaceAll("<br>", "\n");
			questDesc = questDesc.replaceAll("&0", FontColors.BLACK);
			questDesc = questDesc.replaceAll("&1", FontColors.DARK_BLUE);
			questDesc = questDesc.replaceAll("&2", FontColors.DARK_GREEN);
			questDesc = questDesc.replaceAll("&3", FontColors.DARK_AQUA);
			questDesc = questDesc.replaceAll("&4", FontColors.DARK_RED);
			questDesc = questDesc.replaceAll("&5", FontColors.DARK_PURPLE);
			questDesc = questDesc.replaceAll("&6", FontColors.GOLD);
			questDesc = questDesc.replaceAll("&7", FontColors.GRAY);
			questDesc = questDesc.replaceAll("&8", FontColors.DARK_GRAY);
			questDesc = questDesc.replaceAll("&9", FontColors.BLUE);
			questDesc = questDesc.replaceAll("&a", FontColors.GREEN);
			questDesc = questDesc.replaceAll("&b", FontColors.AQUA);
			questDesc = questDesc.replaceAll("&c", FontColors.RED);
			questDesc = questDesc.replaceAll("&d", FontColors.LIGHT_PURPLE);
			questDesc = questDesc.replaceAll("&e", FontColors.YELLOW);
			questDesc = questDesc.replaceAll("&f", FontColors.WHITE);
			// System.out.println(questDesc);
			mc.thePlayer.questsDesc = questDesc;
			mc.thePlayer.questsObjectives = packet.questsObjectives;
			mc.thePlayer.questsRewards = packet.questsRewards;
		}
	}
