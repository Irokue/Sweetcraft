...
public class GuiSac extends GuiContainer
{
	...
	private ItemStack sac;

    public GuiSac(IInventory par1IInventory, IInventory par2IInventory,ItemStack par3ItemStack)
    {
        super(new ContainerSac(par1IInventory, par2IInventory));
		sac = par3ItemStack;
        inventoryRows = 0;
